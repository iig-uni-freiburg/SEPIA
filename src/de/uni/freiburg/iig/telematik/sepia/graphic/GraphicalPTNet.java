...
public class GraphicalPTNet extends GraphicalPN<PTPlace, PTTransition, PTFlowRelation, PTMarking, Integer>{
	...
	public GraphicalPTNet(AbstractPetriNet<PTPlace, PTTransition, PTFlowRelation, PTMarking, Integer> petriNet,
						  PNGraphics<PTPlace, PTTransition, PTFlowRelation, PTMarking, Integer> petriNetGraphics) {
