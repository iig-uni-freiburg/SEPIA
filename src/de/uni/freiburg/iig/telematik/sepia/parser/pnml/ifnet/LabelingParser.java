...
public class LabelingParser {
	...
	public static Labeling parse(File LabelingFile, boolean validate, Collection<AnalysisContext> contexts) throws ParserException {
		...
		// Read clearances
		Map<String, SecurityLevel> clearances = readLabeling(labelingDocument, "clearances", "clearance", "subject", new ArrayList<String>());
		// Read activity classifications
		Map<String, SecurityLevel> activityClassifications = readLabeling(labelingDocument, "classifications", "classification", "activity", new ArrayList<String>());
		...
		List<AnalysisContext> contextCandidates = new ArrayList<AnalysisContext>();
