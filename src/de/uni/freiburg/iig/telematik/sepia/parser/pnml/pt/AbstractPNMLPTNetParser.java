...
public abstract class AbstractPNMLPTNetParser<P extends AbstractPTPlace<F>,
    ...
    /**
     * Gets the place capacity element of a PN and returns an {@link Integer}
     * value.
     *
     * @param placeCapacityElement Place capacity element to read from
     * @return Integer value representing the place capacity
