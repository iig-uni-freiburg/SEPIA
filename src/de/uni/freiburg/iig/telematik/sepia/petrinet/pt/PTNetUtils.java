...
public class PTNetUtils {
	 ...
	 * @throws ParameterException if the number parameter lies outside the valid range [1;26] 
	 */
	public static HashSet<PTTransition> generateTransitions(int number) throws ParameterException {
	...
	public static HashMap<PTPlace, Integer> createSimpleMarking(PTPlace... places) throws ParameterException {
