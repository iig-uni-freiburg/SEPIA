...
public class SNetTest {
	...
	private RegularSNetTransition tr = null;
	...
	public void setUp() throws Exception {
		...
		tr = (RegularSNetTransition) dSNet.getTransition("t0");
	}
	...
	/**
	 * Test method for {@link petrinet.snet.SNet#removeTransition(java.lang.String)}.
	...
	/**
	 * Test method for {@link petrinet.snet.SNet#checkValidity()}.
	 * @throws ParameterException 
	 */
	@Test
	public void testCheckValidity() throws ParameterException {
		...
		SNetFlowRelation outRel = null;
		for(SNetFlowRelation f : dSNet.getFlowRelations()){
	...
	public void testCheckValidityAnalysisContextMissingSubject() throws ParameterException {
		...
		SNet net = SNetTestUtil.createSimpleSnetWithDeclassificationNoAC();
		try {
			net.checkValidity();
			fail("An invalid sNet  is not detected!");
		} catch (PNValidationException e) {
	...
	public void testCheckValidityAnalysisContextDeclassificationTransCreatesHighColor() throws ParameterException {
		...
		SNetFlowRelation tdOutRel = null;
		SNetFlowRelation tdInRel = null;
		for(SNetFlowRelation f : dSNet.getFlowRelations()){
	...
	/**
	 * Test method for {@link petrinet.snet.SNet#SNet()}.
	 */
	@Test
	...
	/**
	 * Test method for {@link petrinet.snet.SNet#SNet(java.util.Set, java.util.Set, petrinet.snet.SNetMarking)}.
	 * @throws ParameterException 
	 */
	@Test
	public void testSNetSetOfStringSetOfStringSNetMarking() throws ParameterException {
		...
		//create the sNet
		SNet net = new SNet(places, transitions, initialMarking);
	...
	/**
	 * Test method for {@link petrinet.snet.SNet#getRegularTransitions()}.
	 */
	@Test
	public void testGetRegularTransitions() {
		
		//get all regular transitions
		Collection<RegularSNetTransition> transitions =  dSNet.getRegularTransitions();
		...
		for(RegularSNetTransition rt : transitions){			
	...
	/**
	 * Test method for {@link petrinet.snet.SNet#getDeclassificationTransitions()}.
	 */
	@Test
	...
	/**
	 * Test method for {@link petrinet.snet.SNet#addDeclassificationTransition(java.lang.String)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link petrinet.snet.SNet#getSubjectDescriptors()}.
	 * @throws ParameterException 
	 */
	@Test
	...
	/**
	 * Test method for {@link petrinet.snet.SNet#getAnalysisContext()}.
	 * @throws ParameterException 
	 */
	@Test
	...
	/**
	 * Test method for {@link petrinet.snet.SNet#setAnalysisContext(petrinet.snet.AnalysisContext)}.
	 * @throws ParameterException 
	 */
	@Test
