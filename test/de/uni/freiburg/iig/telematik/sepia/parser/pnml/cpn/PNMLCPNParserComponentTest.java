...
public class PNMLCPNParserComponentTest {
	...
	@Test(timeout = VALIDATION_TIMEOUT)
	public void validCPNWithValidation() throws BoundednessException {
	...
	@SuppressWarnings("rawtypes")
	@Test(timeout = VALIDATION_TIMEOUT)
	public void validCPNWithoutValidation() throws BoundednessException {
		AbstractGraphicalPN<?,?,?,?,?,?,?> abstrNet = null;
		try {
	...
	public void noNetIDCPNWithValidation() throws ParserException {
		try {
			new PNMLParser().parse(CPNNoNetIDResource.getFile(), true, true);
		} catch (ParameterException e) {
			fail("Exception caused by an invalid parametrization: " + e.getMessage());
		} catch (IOException e) {
			fail("Couldn't read PNML file: " + e.getMessage());
	...
	@SuppressWarnings("rawtypes")
	@Test(timeout = VALIDATION_TIMEOUT)
	public void boundedCPNWithValidation() throws BoundednessException {
		AbstractGraphicalPN<?,?,?,?,?,?,?> abstrNet = null;
		try {
		...
		assertTrue(BoundednessCheck.getBoundedness(abstrNet.getPetriNet()).getBoundedness().equals(Boundedness.BOUNDED));
	}
	...
	@SuppressWarnings("rawtypes")
	@Test(timeout = VALIDATION_TIMEOUT)
	public void boundedCPNWithoutValidation() throws BoundednessException {
		AbstractGraphicalPN<?,?,?,?,?,?,?> abstrNet = null;
		try {
	...
	public void incompleteTokencolorsCPNWithValidation() throws ParserException {
		try {
			new PNMLParser().parse(CPNIncompleteTokencolorsResource.getFile(), true, true);
		} catch (ParameterException e) {
			fail("Exception caused by an invalid parametrization: " + e.getMessage());
		} catch (IOException e) {
			fail("Couldn't read PNML file: " + e.getMessage());
